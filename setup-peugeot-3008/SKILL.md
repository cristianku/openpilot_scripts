...
description: Prepare Cristian's stable Peugeot 3008 openpilot workspace directly from the current upstream comma 4 release-mici branch and vendor the complete custom opendbc tree. Use variant comma for peugeot-3008 or sunny for peugeot-3008-sunny.
---
...
4. Report the upstream release commit and whether the workflow updated and pushed the openpilot branch.
