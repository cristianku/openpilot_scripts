...
4. Report the source mode, resolved upstream source commit and release tag when applicable, opendbc pointer commit, Sunny neural-network-data pointer and NNLC patch status when applicable, and whether the workflow pushed the openpilot testing branch.
